...
// Output: CSV-like lines per benchmark:
// name,dimension_bits,bytes_per_iter,iterations,seconds,gb_per_sec
...
template <std::size_t Dim>
static inline void BindAVX2_Ref(const HyperVector<Dim, bool>& a, const HyperVector<Dim, bool>& b,
